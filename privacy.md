...
- Discovers Roku, Samsung, LG, Android TV / Google TV, Fire TV, and Apple TV devices on your local WiFi network using standard device-discovery protocols (SSDP and Bonjour/mDNS).
...
- **Your TV viewing habits, search history, and typed text are never read, stored, or transmitted** to anyone — text you type is sent only to the TV you are controlling.
...
- If you decline consent, you will still see ads, but they will be **non-personalized**.
